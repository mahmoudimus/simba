...
class TestStoreUsesResolvedProjectId:
    def test_store_failure_rule_resolves_project_id(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr(
            simba.hooks._memory_client, "store_memory", fake_store
        )
